...
class ItemController extends Controller
{
    ...
    public function store(CreateRequest $request)
    {
        ...
        */
        ...
        $dataInput = $request->only(['nama', 'deskripsi', 'harga', 'foto', 'fotoUrl' ,'is_available', 'kategori', 'detail']);
    ...
    public function update(UpdateRequest $request)
    {
        ...
        $dataInput = $request->only(['nama', 'deskripsi', 'harga', 'foto', 'fotoUrl', 'is_available', 'kategori', 'id', 'detail']);
